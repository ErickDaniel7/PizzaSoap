...
public class ItensPedido {
    ...
    @ManyToOne(cascade = CascadeType.PERSIST)  // Cascata para salvar Pizza automaticamente
    ...
    public ItensPedido(String tamanho, int quantidade, Pizza pizza) {
    ...
    // Cálculo do valor total do item do pedido
    @PrePersist
    @PreUpdate
    public void calcularValor() {
        ...
        if (pizza != null) {
            precoPizza = pizza.getPreco(); // Usa o preço já definido na classe Pizza
        }

        if (borda != null && borda.getPreco() != null) {
            precoBorda = borda.getPreco(); // Se a borda existir, pega o preço
        }
